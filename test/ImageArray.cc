...
int FuncDoodle_RunImageArrayTests() {
	...
	FuncDoodle::ImageArray arr2(
		5, 5, FuncDoodle::Col{.r = 128, .g = 128, .b = 128});
	...
	arr3.SetData(std::vector<FuncDoodle::Col>(
		9, FuncDoodle::Col{.r = 255, .g = 255, .b = 0}));
	...
	FuncDoodle::ImageArray arr_small(
		1, 1, FuncDoodle::Col{.r = 100, .g = 100, .b = 100});
