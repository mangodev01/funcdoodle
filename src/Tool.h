/**
 * @file Tool.h
 * @brief Defines editor tools, tool utilities, and tool-related keybinding logic.
 *
 * This file contains:
 ...
 *
 * It provides a lightweight functional layer for tool selection and UI integration,
 * primarily used by ToolManager and editor input systems.
 *
 * @note Tool utilities are implemented as constexpr/static helpers for simplicity.
 */
...
namespace FuncDoodle {
	...
	// yea i really have nothing to say about this method idk why i put a comment here
